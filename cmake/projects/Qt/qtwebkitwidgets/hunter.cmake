...
if(DEFINED HUNTER_CMAKE_PROJECTS_QT_QTWEBKITWIDGETS_HUNTER_CMAKE_)
  return()
else()
  set(HUNTER_CMAKE_PROJECTS_QT_QTWEBKITWIDGETS_HUNTER_CMAKE_ 1)
endif()
...
## 5.5 only --
string(COMPARE EQUAL "qtwebkitwidgets" "qtquick1" _is_qtquick1)
string(COMPARE EQUAL "qtwebkitwidgets" "qtwebkit" _is_qtwebkit)
string(COMPARE EQUAL "qtwebkitwidgets" "qtwebkit-examples" _is_qtwebkit_examples)
...
## 5.6 only --
string(COMPARE EQUAL "qtwebkitwidgets" "qtquickcontrol2" _is_qtquickcontrols2)
string(COMPARE EQUAL "qtwebkitwidgets" "qtwebview" _is_qtwebview)
...
list(FIND _nobuild "qtwebkitwidgets" _dont_build_it)
if(NOT _dont_build_it EQUAL -1)
  hunter_status_debug(
      "Qt component doesn't install anything and will be skipped: qtwebkitwidgets"
  )
  return()
endif()

string(COMPARE EQUAL "qtwebkitwidgets" "qtdeclarative" _is_qtdeclarative)
...
hunter_flat_download(
    PACKAGE_NAME Qt
    PACKAGE_COMPONENT "qtwebkitwidgets"
