...
if(DEFINED HUNTER_CMAKE_PROJECTS_QT_QTMULTIMEDIAQUICK_P_HUNTER_CMAKE_)
  return()
else()
  set(HUNTER_CMAKE_PROJECTS_QT_QTMULTIMEDIAQUICK_P_HUNTER_CMAKE_ 1)
endif()
...
## 5.5 only --
string(COMPARE EQUAL "qtmultimediaquick_p" "qtquick1" _is_qtquick1)
string(COMPARE EQUAL "qtmultimediaquick_p" "qtwebkit" _is_qtwebkit)
string(COMPARE EQUAL "qtmultimediaquick_p" "qtwebkit-examples" _is_qtwebkit_examples)
...
## 5.6 only --
string(COMPARE EQUAL "qtmultimediaquick_p" "qtquickcontrol2" _is_qtquickcontrols2)
string(COMPARE EQUAL "qtmultimediaquick_p" "qtwebview" _is_qtwebview)
...
list(FIND _nobuild "qtmultimediaquick_p" _dont_build_it)
if(NOT _dont_build_it EQUAL -1)
  hunter_status_debug(
      "Qt component doesn't install anything and will be skipped: qtmultimediaquick_p"
  )
  return()
endif()

string(COMPARE EQUAL "qtmultimediaquick_p" "qtdeclarative" _is_qtdeclarative)
...
hunter_flat_download(
    PACKAGE_NAME Qt
    PACKAGE_COMPONENT "qtmultimediaquick_p"
