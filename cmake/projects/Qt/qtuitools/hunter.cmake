...
if(DEFINED HUNTER_CMAKE_PROJECTS_QT_QTUITOOLS_HUNTER_CMAKE_)
  return()
else()
  set(HUNTER_CMAKE_PROJECTS_QT_QTUITOOLS_HUNTER_CMAKE_ 1)
endif()
...
## 5.5 only --
string(COMPARE EQUAL "qtuitools" "qtquick1" _is_qtquick1)
string(COMPARE EQUAL "qtuitools" "qtwebkit" _is_qtwebkit)
string(COMPARE EQUAL "qtuitools" "qtwebkit-examples" _is_qtwebkit_examples)
...
## 5.6 only --
string(COMPARE EQUAL "qtuitools" "qtquickcontrol2" _is_qtquickcontrols2)
string(COMPARE EQUAL "qtuitools" "qtwebview" _is_qtwebview)
...
list(FIND _nobuild "qtuitools" _dont_build_it)
if(NOT _dont_build_it EQUAL -1)
  hunter_status_debug(
      "Qt component doesn't install anything and will be skipped: qtuitools"
  )
  return()
endif()

string(COMPARE EQUAL "qtuitools" "qtdeclarative" _is_qtdeclarative)
