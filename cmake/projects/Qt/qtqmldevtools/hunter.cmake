...
if(DEFINED HUNTER_CMAKE_PROJECTS_QT_QTQMLDEVTOOLS_HUNTER_CMAKE_)
  return()
else()
  set(HUNTER_CMAKE_PROJECTS_QT_QTQMLDEVTOOLS_HUNTER_CMAKE_ 1)
endif()
...
## 5.5 only --
string(COMPARE EQUAL "qtqmldevtools" "qtquick1" _is_qtquick1)
string(COMPARE EQUAL "qtqmldevtools" "qtwebkit" _is_qtwebkit)
string(COMPARE EQUAL "qtqmldevtools" "qtwebkit-examples" _is_qtwebkit_examples)
...
## 5.6 only --
string(COMPARE EQUAL "qtqmldevtools" "qtquickcontrol2" _is_qtquickcontrols2)
string(COMPARE EQUAL "qtqmldevtools" "qtwebview" _is_qtwebview)
...
list(FIND _nobuild "qtqmldevtools" _dont_build_it)
if(NOT _dont_build_it EQUAL -1)
  hunter_status_debug(
      "Qt component doesn't install anything and will be skipped: qtqmldevtools"
  )
  return()
endif()

string(COMPARE EQUAL "qtqmldevtools" "qtdeclarative" _is_qtdeclarative)
...
hunter_flat_download(
    PACKAGE_NAME Qt
    PACKAGE_COMPONENT "qtqmldevtools"
