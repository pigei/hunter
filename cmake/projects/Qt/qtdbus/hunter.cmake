...
if(DEFINED HUNTER_CMAKE_PROJECTS_QT_QTDBUS_HUNTER_CMAKE_)
  return()
else()
  set(HUNTER_CMAKE_PROJECTS_QT_QTDBUS_HUNTER_CMAKE_ 1)
endif()
...
## 5.5 only --
string(COMPARE EQUAL "qtdbus" "qtquick1" _is_qtquick1)
string(COMPARE EQUAL "qtdbus" "qtwebkit" _is_qtwebkit)
string(COMPARE EQUAL "qtdbus" "qtwebkit-examples" _is_qtwebkit_examples)
...
## 5.6 only --
string(COMPARE EQUAL "qtdbus" "qtquickcontrol2" _is_qtquickcontrols2)
string(COMPARE EQUAL "qtdbus" "qtwebview" _is_qtwebview)
...
list(FIND _nobuild "qtdbus" _dont_build_it)
if(NOT _dont_build_it EQUAL -1)
  hunter_status_debug(
      "Qt component doesn't install anything and will be skipped: qtdbus"
  )
  return()
endif()

string(COMPARE EQUAL "qtdbus" "qtdeclarative" _is_qtdeclarative)
