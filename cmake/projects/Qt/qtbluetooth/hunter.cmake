...
if(DEFINED HUNTER_CMAKE_PROJECTS_QT_QTBLUETOOTH_HUNTER_CMAKE_)
  return()
else()
  set(HUNTER_CMAKE_PROJECTS_QT_QTBLUETOOTH_HUNTER_CMAKE_ 1)
endif()
...
## 5.5 only --
string(COMPARE EQUAL "qtbluetooth" "qtquick1" _is_qtquick1)
string(COMPARE EQUAL "qtbluetooth" "qtwebkit" _is_qtwebkit)
string(COMPARE EQUAL "qtbluetooth" "qtwebkit-examples" _is_qtwebkit_examples)
...
## 5.6 only --
string(COMPARE EQUAL "qtbluetooth" "qtquickcontrol2" _is_qtquickcontrols2)
string(COMPARE EQUAL "qtbluetooth" "qtwebview" _is_qtwebview)
...
list(FIND _nobuild "qtbluetooth" _dont_build_it)
if(NOT _dont_build_it EQUAL -1)
  hunter_status_debug(
      "Qt component doesn't install anything and will be skipped: qtbluetooth"
  )
  return()
endif()

string(COMPARE EQUAL "qtbluetooth" "qtdeclarative" _is_qtdeclarative)
