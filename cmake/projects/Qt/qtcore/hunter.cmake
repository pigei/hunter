...
if(DEFINED HUNTER_CMAKE_PROJECTS_QT_QTCORE_HUNTER_CMAKE_)
  return()
else()
  set(HUNTER_CMAKE_PROJECTS_QT_QTCORE_HUNTER_CMAKE_ 1)
endif()
...
## 5.5 only --
string(COMPARE EQUAL "qtcore" "qtquick1" _is_qtquick1)
string(COMPARE EQUAL "qtcore" "qtwebkit" _is_qtwebkit)
string(COMPARE EQUAL "qtcore" "qtwebkit-examples" _is_qtwebkit_examples)
...
## 5.6 only --
string(COMPARE EQUAL "qtcore" "qtquickcontrol2" _is_qtquickcontrols2)
string(COMPARE EQUAL "qtcore" "qtwebview" _is_qtwebview)
...
list(FIND _nobuild "qtcore" _dont_build_it)
if(NOT _dont_build_it EQUAL -1)
  hunter_status_debug(
      "Qt component doesn't install anything and will be skipped: qtcore"
  )
  return()
endif()

string(COMPARE EQUAL "qtcore" "qtdeclarative" _is_qtdeclarative)
