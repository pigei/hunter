...
if(DEFINED HUNTER_CMAKE_PROJECTS_QT_QTMULTIMEDIAWIDGETS_HUNTER_CMAKE_)
  return()
else()
  set(HUNTER_CMAKE_PROJECTS_QT_QTMULTIMEDIAWIDGETS_HUNTER_CMAKE_ 1)
endif()
...
## 5.5 only --
string(COMPARE EQUAL "qtmultimediawidgets" "qtquick1" _is_qtquick1)
string(COMPARE EQUAL "qtmultimediawidgets" "qtwebkit" _is_qtwebkit)
string(COMPARE EQUAL "qtmultimediawidgets" "qtwebkit-examples" _is_qtwebkit_examples)
...
## 5.6 only --
string(COMPARE EQUAL "qtmultimediawidgets" "qtquickcontrol2" _is_qtquickcontrols2)
string(COMPARE EQUAL "qtmultimediawidgets" "qtwebview" _is_qtwebview)
...
list(FIND _nobuild "qtmultimediawidgets" _dont_build_it)
if(NOT _dont_build_it EQUAL -1)
  hunter_status_debug(
      "Qt component doesn't install anything and will be skipped: qtmultimediawidgets"
  )
  return()
endif()

string(COMPARE EQUAL "qtmultimediawidgets" "qtdeclarative" _is_qtdeclarative)
...
hunter_flat_download(
    PACKAGE_NAME Qt
    PACKAGE_COMPONENT "qtmultimediawidgets"
