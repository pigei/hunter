...
if(DEFINED HUNTER_CMAKE_PROJECTS_QT_QTPRINTSUPPORT_HUNTER_CMAKE_)
  return()
else()
  set(HUNTER_CMAKE_PROJECTS_QT_QTPRINTSUPPORT_HUNTER_CMAKE_ 1)
endif()
...
## 5.5 only --
string(COMPARE EQUAL "qtprintsupport" "qtquick1" _is_qtquick1)
string(COMPARE EQUAL "qtprintsupport" "qtwebkit" _is_qtwebkit)
string(COMPARE EQUAL "qtprintsupport" "qtwebkit-examples" _is_qtwebkit_examples)
...
## 5.6 only --
string(COMPARE EQUAL "qtprintsupport" "qtquickcontrol2" _is_qtquickcontrols2)
string(COMPARE EQUAL "qtprintsupport" "qtwebview" _is_qtwebview)
...
list(FIND _nobuild "qtprintsupport" _dont_build_it)
if(NOT _dont_build_it EQUAL -1)
  hunter_status_debug(
      "Qt component doesn't install anything and will be skipped: qtprintsupport"
  )
  return()
endif()

string(COMPARE EQUAL "qtprintsupport" "qtdeclarative" _is_qtdeclarative)
...
hunter_flat_download(
    PACKAGE_NAME Qt
    PACKAGE_COMPONENT "qtprintsupport"
