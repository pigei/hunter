...
if(DEFINED HUNTER_CMAKE_PROJECTS_QT_QTXML_HUNTER_CMAKE_)
  return()
else()
  set(HUNTER_CMAKE_PROJECTS_QT_QTXML_HUNTER_CMAKE_ 1)
endif()
...
## 5.5 only --
string(COMPARE EQUAL "qtxml" "qtquick1" _is_qtquick1)
string(COMPARE EQUAL "qtxml" "qtwebkit" _is_qtwebkit)
string(COMPARE EQUAL "qtxml" "qtwebkit-examples" _is_qtwebkit_examples)
...
## 5.6 only --
string(COMPARE EQUAL "qtxml" "qtquickcontrol2" _is_qtquickcontrols2)
string(COMPARE EQUAL "qtxml" "qtwebview" _is_qtwebview)
...
list(FIND _nobuild "qtxml" _dont_build_it)
if(NOT _dont_build_it EQUAL -1)
  hunter_status_debug(
      "Qt component doesn't install anything and will be skipped: qtxml"
  )
  return()
endif()

string(COMPARE EQUAL "qtxml" "qtdeclarative" _is_qtdeclarative)
