...
if(DEFINED HUNTER_CMAKE_PROJECTS_QT_QTUIPLUGIN_HUNTER_CMAKE_)
  return()
else()
  set(HUNTER_CMAKE_PROJECTS_QT_QTUIPLUGIN_HUNTER_CMAKE_ 1)
endif()
...
## 5.5 only --
string(COMPARE EQUAL "qtuiplugin" "qtquick1" _is_qtquick1)
string(COMPARE EQUAL "qtuiplugin" "qtwebkit" _is_qtwebkit)
string(COMPARE EQUAL "qtuiplugin" "qtwebkit-examples" _is_qtwebkit_examples)
...
## 5.6 only --
string(COMPARE EQUAL "qtuiplugin" "qtquickcontrol2" _is_qtquickcontrols2)
string(COMPARE EQUAL "qtuiplugin" "qtwebview" _is_qtwebview)
...
list(FIND _nobuild "qtuiplugin" _dont_build_it)
if(NOT _dont_build_it EQUAL -1)
  hunter_status_debug(
      "Qt component doesn't install anything and will be skipped: qtuiplugin"
  )
  return()
endif()

string(COMPARE EQUAL "qtuiplugin" "qtdeclarative" _is_qtdeclarative)
