...
if(DEFINED HUNTER_CMAKE_PROJECTS_QT_QTPLATFORMHEADERS_HUNTER_CMAKE_)
  return()
else()
  set(HUNTER_CMAKE_PROJECTS_QT_QTPLATFORMHEADERS_HUNTER_CMAKE_ 1)
endif()
...
## 5.5 only --
string(COMPARE EQUAL "qtplatformheaders" "qtquick1" _is_qtquick1)
string(COMPARE EQUAL "qtplatformheaders" "qtwebkit" _is_qtwebkit)
string(COMPARE EQUAL "qtplatformheaders" "qtwebkit-examples" _is_qtwebkit_examples)
...
## 5.6 only --
string(COMPARE EQUAL "qtplatformheaders" "qtquickcontrol2" _is_qtquickcontrols2)
string(COMPARE EQUAL "qtplatformheaders" "qtwebview" _is_qtwebview)
...
list(FIND _nobuild "qtplatformheaders" _dont_build_it)
if(NOT _dont_build_it EQUAL -1)
  hunter_status_debug(
      "Qt component doesn't install anything and will be skipped: qtplatformheaders"
  )
  return()
endif()

string(COMPARE EQUAL "qtplatformheaders" "qtdeclarative" _is_qtdeclarative)
...
hunter_flat_download(
    PACKAGE_NAME Qt
    PACKAGE_COMPONENT "qtplatformheaders"
