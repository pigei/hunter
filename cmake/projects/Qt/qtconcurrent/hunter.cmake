...
if(DEFINED HUNTER_CMAKE_PROJECTS_QT_QTCONCURRENT_HUNTER_CMAKE_)
  return()
else()
  set(HUNTER_CMAKE_PROJECTS_QT_QTCONCURRENT_HUNTER_CMAKE_ 1)
endif()
...
## 5.5 only --
string(COMPARE EQUAL "qtconcurrent" "qtquick1" _is_qtquick1)
string(COMPARE EQUAL "qtconcurrent" "qtwebkit" _is_qtwebkit)
string(COMPARE EQUAL "qtconcurrent" "qtwebkit-examples" _is_qtwebkit_examples)
...
## 5.6 only --
string(COMPARE EQUAL "qtconcurrent" "qtquickcontrol2" _is_qtquickcontrols2)
string(COMPARE EQUAL "qtconcurrent" "qtwebview" _is_qtwebview)
...
list(FIND _nobuild "qtconcurrent" _dont_build_it)
if(NOT _dont_build_it EQUAL -1)
  hunter_status_debug(
      "Qt component doesn't install anything and will be skipped: qtconcurrent"
  )
  return()
endif()

string(COMPARE EQUAL "qtconcurrent" "qtdeclarative" _is_qtdeclarative)
...
hunter_flat_download(
    PACKAGE_NAME Qt
    PACKAGE_COMPONENT "qtconcurrent"
