...
if(DEFINED HUNTER_CMAKE_PROJECTS_QT_QTWIDGETS_HUNTER_CMAKE_)
  return()
else()
  set(HUNTER_CMAKE_PROJECTS_QT_QTWIDGETS_HUNTER_CMAKE_ 1)
endif()
...
## 5.5 only --
string(COMPARE EQUAL "qtwidgets" "qtquick1" _is_qtquick1)
string(COMPARE EQUAL "qtwidgets" "qtwebkit" _is_qtwebkit)
string(COMPARE EQUAL "qtwidgets" "qtwebkit-examples" _is_qtwebkit_examples)
...
## 5.6 only --
string(COMPARE EQUAL "qtwidgets" "qtquickcontrol2" _is_qtquickcontrols2)
string(COMPARE EQUAL "qtwidgets" "qtwebview" _is_qtwebview)
...
list(FIND _nobuild "qtwidgets" _dont_build_it)
if(NOT _dont_build_it EQUAL -1)
  hunter_status_debug(
      "Qt component doesn't install anything and will be skipped: qtwidgets"
  )
  return()
endif()

string(COMPARE EQUAL "qtwidgets" "qtdeclarative" _is_qtdeclarative)
