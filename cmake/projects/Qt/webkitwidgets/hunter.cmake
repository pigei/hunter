...
if(DEFINED HUNTER_CMAKE_PROJECTS_Qt_WEBKITWIDGETS_HUNTER_CMAKE_)
  return()
else()
  set(HUNTER_CMAKE_PROJECTS_Qt_WEBKITWIDGETS_HUNTER_CMAKE_ 1)
endif()
...
hunter_flat_download(
    PACKAGE_NAME Qt
    PACKAGE_COMPONENT "webkitwidgets"
