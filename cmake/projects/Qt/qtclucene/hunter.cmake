...
if(DEFINED HUNTER_CMAKE_PROJECTS_QT_QTCLUCENE_HUNTER_CMAKE_)
  return()
else()
  set(HUNTER_CMAKE_PROJECTS_QT_QTCLUCENE_HUNTER_CMAKE_ 1)
endif()
...
## 5.5 only --
string(COMPARE EQUAL "qtclucene" "qtquick1" _is_qtquick1)
string(COMPARE EQUAL "qtclucene" "qtwebkit" _is_qtwebkit)
string(COMPARE EQUAL "qtclucene" "qtwebkit-examples" _is_qtwebkit_examples)
...
## 5.6 only --
string(COMPARE EQUAL "qtclucene" "qtquickcontrol2" _is_qtquickcontrols2)
string(COMPARE EQUAL "qtclucene" "qtwebview" _is_qtwebview)
...
list(FIND _nobuild "qtclucene" _dont_build_it)
if(NOT _dont_build_it EQUAL -1)
  hunter_status_debug(
      "Qt component doesn't install anything and will be skipped: qtclucene"
  )
  return()
endif()

string(COMPARE EQUAL "qtclucene" "qtdeclarative" _is_qtdeclarative)
