...
if(DEFINED HUNTER_CMAKE_PROJECTS_TBB_HUNTER_CMAKE_)
  return()
else()
  set(HUNTER_CMAKE_PROJECTS_TBB_HUNTER_CMAKE_ 1)
endif()
...
if ("${_buildType}" STREQUAL "msvc2013-amd64")
	...
	hunter_add_version(
		PACKAGE_NAME tbb
		VERSION     "4.3.2"
		URL			"${HUNTER_SERVER_URL}/tbb/${HUNTER_MSVC_RUNTIME}-${HUNTER_MSVC_ARCH}/tbb-4.3.2.tar.gz"
...
elseif ("${_buildType}" STREQUAL "msvc2013-x86")
	...
	hunter_fatal_error("No tarball available for tbb ${_buildType}"  WIKI "error.external.build.missing")
endif()
...
hunter_flat_download(PACKAGE_NAME tbb PACKAGE_USR ${HUNTER_SERVER_USR} PACKAGE_PSW ${HUNTER_SERVER_PSW})
